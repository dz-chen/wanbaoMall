        ...
        handler:function(){
        	...
        	$("#itemEditWindow").window({
        		onLoad :function(){
        			...
        			$.ajax({
        				   type: "GET",       
        				   url: "/rest/item/cat/getCatName?cid="+data.cid,
        				   success: function(catName){
        					   //$("#itemeEditForm [name=cid]").val(catName);
        					   $("#itemeEditForm [name=cid]").siblings('span').text(catName);
        				   },
        				   error: function(){
        					   alert("获取商品类别名称失败!");
        				   }
