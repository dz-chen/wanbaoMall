...
import com.wanbao.common.bean.PicUploadResult;
import com.wanbao.manage.service.ProperttiesService;
...
public class PicUploadController {
	...
	@Autowired    //properttiesService来自父容器,子容器通过父容器间接获取
	ProperttiesService properttiesService;
	// 允许上传的格式
	...
	public String upload(@RequestParam("uploadFile") MultipartFile uploadFile , HttpServletResponse response) throws Exception {
		...
		fileUploadResult.setUrl(properttiesService.IMAGE_URL + picUrl);
